...
8. Employees may only use Cloudticity-purchased and -owned workstations for accessing production systems with access to ePHI data.
   ...
   * Any workstations used to access production systems must have virus protection, with anti-spyware, software installed, configured, and enabled according to [§7.8](07-systems_access_policy.md#78-employee-workstation-use).
